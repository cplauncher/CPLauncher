...
def build_windows():
    ...
    if not os.path.exists("release/CpLauncher.exe"):
        sys.exit('Build has been finished, but release/CpLauncher.exe file is not present in build folder')
    os.makedirs("CpLauncher/platforms")
    os.makedirs("CpLauncher/styles")
    os.makedirs("CpLauncher/plugins/audio")
    os.makedirs("CpLauncher/plugins/bearer")
    os.makedirs("CpLauncher/plugins/imageformats")
    os.makedirs("CpLauncher/plugins/sqldrivers")
    ...
    shutil.copy2(f'{full_qt_dir}/plugins/platforms/qwindows.dll', './CpLauncher/platforms')
    shutil.copy2(f'{full_qt_dir}/plugins/styles/qwindowsvistastyle.dll', './CpLauncher/styles')
    shutil.copy2(f'{full_qt_dir}/plugins/audio/qtaudio_wasapi.dll', './CpLauncher/plugins/audio')
    shutil.copy2(f'{full_qt_dir}/plugins/audio/qtaudio_windows.dll', './CpLauncher/plugins/audio')
    shutil.copy2(f'{full_qt_dir}/plugins/bearer/qgenericbearer.dll', './CpLauncher/plugins/bearer')
    shutil.copy2(f'{full_qt_dir}/plugins/imageformats/qgif.dll', './CpLauncher/plugins/imageformats')
    shutil.copy2(f'{full_qt_dir}/plugins/imageformats/qicns.dll', './CpLauncher/plugins/imageformats')
    shutil.copy2(f'{full_qt_dir}/plugins/imageformats/qico.dll', './CpLauncher/plugins/imageformats')
    shutil.copy2(f'{full_qt_dir}/plugins/imageformats/qjpeg.dll', './CpLauncher/plugins/imageformats')
    shutil.copy2(f'{full_qt_dir}/plugins/imageformats/qwbmp.dll', './CpLauncher/plugins/imageformats')
    shutil.copy2(f'{full_qt_dir}/plugins/sqldrivers/qsqlite.dll', './CpLauncher/plugins/sqldrivers')
    version = get_version()
    shutil.make_archive("CpLauncher_" + version + "_Windows", 'zip', 'CpLauncher')
    print("Finish")
